...
class DeliveryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        replaceFragment(DeliveryFragmentName.DELIVERY_MANAGER_FRAGMENT, false, false, null)
    ...
    fun replaceFragment(name:DeliveryFragmentName, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
